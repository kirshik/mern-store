import { BrowserRouter as Router, Routes, Route, Outlet, useParams, useNavigate, BrowserRouter } from 'react-router-dom';
...
function App() {
  ...
  const handleShowAddToCartModalClose = () => setShowAddToCartModal(false);
  const handleShowAddToCartModalShow = () => setShowAddToCartModal(true);
  ...
  const routes =
    <Routes>
      <Route path="/" element={<Home header={header} footer={footer} categories={categories}
        addToWishList={addToWishList} addToCart={handleShowAddToCartModalShow} setProductId={setCurrentProductId} />} />
      <Route path="/categories" element={<Categories addToWishList={addToWishList} header={header} footer={footer} categories={categories} addToCart={handleShowAddToCartModalShow} setProductId={setCurrentProductId} />} />
  ...
  return (
    <>
      ...
      <AddToCartModal show={showAddToCartModal} productId={currentProductId} handleClose={handleShowAddToCartModalClose} />
